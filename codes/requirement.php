...
<script>
    function docheck(){
		...
		if(document.form.gn.value==""){
        alert("Please enter other gage name!");
        return false;
        }
...
<tr>
<td bgcolor="#D8D8D8"><strong>Gage Name</strong></td>
<td>: <input type="text" name="gn" style="width:60mm" ></td>
</tr>

<tr>
<td bgcolor="#D8D8D8"><strong>Gage Type</strong></td>
<td >: <input type="text" name="gt" style="width:60mm" ></td>
</tr>
<tr>
<td bgcolor="#D8D8D8"><strong>Gage No</strong></td>
<td>: <input type="text" name="gno" style="width:60mm" ></td>
</tr>
<tr>
<td bgcolor="#D8D8D8"><strong>Date</strong></td>
<td>: <input type="text" name="dt" style="width:60mm" ></td>
</tr>
<tr>
 <td bgcolor="#D8D8D8"><strong>Trial</strong></td> 
...
<tr>
<td bgcolor="#D8D8D8"><strong>Appraiser</strong></td>
...
<tr>
<td bgcolor="#D8D8D8"><strong>Appraiser 1</strong></td>
<td>: <input type="text" name="apa" style="width:60mm" ></td>
</tr>
<tr>
<td bgcolor="#D8D8D8"><strong>Appraiser 2</strong></td>
<td>: <input type="text" name="apb" style="width:60mm" ></td>
</tr>
<tr>
<td bgcolor="#D8D8D8"><strong>Appraiser 3</strong></td>
<td>: <input type="text" name="apc" style="width:60mm" ></td>
</tr>
<tr>
<td bgcolor="#D8D8D8"><strong>Sample Size</strong></td>
...
if (!mysql_query($sql,$con))
  {
	  ?>
<script>alert("Gage name <?php echo "$_POST[gn]" ?> has already being used!Please insert other name.");
...
// alert("UNSuccessful!");
  ...
  ?>
  <script>alert("Requirement have been captured successfully for <?php echo "$_POST[gn]" ?> ! Please proceed to the Measurement page");</script>
  <?php
}
