...
<!--Content of the webpage-->
                      <td width="465" align="left" class="text4">
                        <p align="left">Gage Repeatability and Reproducibility (Gage R&R)is a tool to measure the amount of variation in the measurement system arising from the measurement device and the people taking the measurements.
It is developed using PHP and Java Script and the databases developed using SQL Yog.  And  deployment of Gage R&R made in Github. 
Usually, a gage R&R study is performed using 2 to 3 appraisers and 5 to 10 parts/samples. Each appraiser measures the parts/samples multiple times.  </a>.</p>

For more information, you can refer to the attached document, which provide the guidelines for Measurement Analysis Tool (Gage R&R) : <a href="MSA Guidelines.docx"><font color="#0000EE">MSA Gage R&R Guidelines.docx</a></p></font><p>
Gage R&R (Gage Repeatability and Reproducibility) is the amount of measurement variation introduced by a measurement system, which consists of the measuring instrument itself and the individuals using the instrument. A Gage R&R study is a critical step in manufacturing Six Sigma projects, and it quantifies three things:</p><p>

1.Repeatability – variation from the measurement instrument</p><p>
2.Reproducibility – variation from the individuals using the instrument</p><p>
3.Overall Gage R&R, which is the combined effect of (1) and (2)</p><p>
The overall Gage R&R is normally expressed as a percentage of the tolerance for the CTQ being studied, and a value of 20% Gage R&R or less is considered acceptable in most cases.
